...
xst -ifn xst.scr
move DCM_IP_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\DCM_IP_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc DCM_IP_exdes.ucf DCM_IP_exdes

echo 'Running map'
map -timing -pr b DCM_IP_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm DCM_IP_exdes -w routed.ncd routed.vhd
cd ..
